...
import app.revanced.integrations.patches.misc.requests.StreamingDataRequest;
import app.revanced.integrations.settings.SettingsEnum;
import app.revanced.integrations.utils.Logger;

@SuppressWarnings("unused")
public class SpoofStreamingDataPatch {
    private static final boolean SPOOF_STREAMING_DATA = SettingsEnum.SPOOF_STREAMING_DATA.getBoolean();
...
//                    }
    ...
    public static String appendSpoofedClient(String videoFormat) {
        try {
            if (SPOOF_STREAMING_DATA && SettingsEnum.SPOOF_STREAMING_DATA_STATS_FOR_NERDS.getBoolean()
