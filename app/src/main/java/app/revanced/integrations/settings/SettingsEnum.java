...
public enum SettingsEnum {
    ...
    ENABLE_CUSTOM_SEEKBAR_COLOR("revanced_enable_custom_seekbar_color", false, ReturnType.BOOLEAN, true),
    ENABLE_CUSTOM_SEEKBAR_COLOR_VALUE("revanced_custom_seekbar_color_value", "#ff0000", ReturnType.STRING, true),
    HIDE_SEEKBAR_THUMBNAIL("revanced_hide_seekbar_thumbnail", false, ReturnType.BOOLEAN),
